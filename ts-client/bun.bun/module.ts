...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgCreatePost({ value }: msgCreatePostParams): EncodeObject {
			try {
				return { typeUrl: "/bun.bun.MsgCreatePost", value: MsgCreatePost.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateComment({ value }: msgCreateCommentParams): EncodeObject {
			try {
				return { typeUrl: "/bun.bun.MsgCreateComment", value: MsgCreateComment.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeleteComment({ value }: msgDeleteCommentParams): EncodeObject {
			try {
				return { typeUrl: "/bun.bun.MsgDeleteComment", value: MsgDeleteComment.fromPartial( value ) }  
			} catch (e: any) {
