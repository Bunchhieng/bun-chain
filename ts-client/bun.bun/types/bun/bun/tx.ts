...
export class MsgClientImpl implements Msg {
  ...
  CreatePost(request: MsgCreatePost): Promise<MsgCreatePostResponse> {
    ...
    const promise = this.rpc.request("bun.bun.Msg", "CreatePost", data);
  ...
  CreateComment(request: MsgCreateComment): Promise<MsgCreateCommentResponse> {
    ...
    const promise = this.rpc.request("bun.bun.Msg", "CreateComment", data);
  ...
  DeleteComment(request: MsgDeleteComment): Promise<MsgDeleteCommentResponse> {
    ...
    const promise = this.rpc.request("bun.bun.Msg", "DeleteComment", data);
